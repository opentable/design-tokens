  ...
  expect(mockWrite.mock.calls[0][1]).toEqual({
    ...
    props: {
      ic_award: {
        type: 'xml',
        value:
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19 5h1a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-1c-.024 0-.047 0-.07-.002A7.005 7.005 0 0 1 13 16.929V19h2.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5H11v-2.07a7.005 7.005 0 0 1-5.93-5.932A1.015 1.015 0 0 1 5 11H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1v-.833C5 3.522 5.522 3 6.167 3h11.666C18.478 3 19 3.522 19 4.167V5zM7 5v5a5 5 0 0 0 10 0V5H7z"/></svg>'
      },
      ic_ticket: {
        type: 'xml',
        value:
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9.707 8.85l-5.379 5.378.472.471c1.39-.36 2.585-.04 3.584.959 1 1 1.387 2.262 1.162 3.787l.44.44 5.378-5.379-5.657-5.657zm1.414-1.415l5.657 5.657 3.107-3.107-.472-.471c-1.403.145-2.605-.281-3.604-1.28-1-1-1.37-2.145-1.11-3.434l-.471-.472-3.107 3.107zm-8.207 5.379l9.9-9.9a2 2 0 0 1 2.828 0l.792.792a1 1 0 0 1 .156 1.211c-.436.747-.28 1.493.466 2.24.747.747 1.494.902 2.24.466a1 1 0 0 1 1.212.157l.791.791a2 2 0 0 1 0 2.829l-9.9 9.9a2 2 0 0 1-2.828 0l-.791-.793a1 1 0 0 1-.157-1.21c.436-.747.28-1.494-.466-2.24-.747-.747-1.493-.903-2.24-.467a1 1 0 0 1-1.211-.156l-.792-.792a2 2 0 0 1 0-2.828z"/></svg>'
      },
