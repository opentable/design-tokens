export default {
  ...
  "phase2.description1": "Share work early in the process to allow both sides to gain a deeper understanding of the problem and allow engineers to ideate with designers. As you share or provide feedback, remember these tips:",

  "phase2.header1.list1.title": "When requesting feedback remember to:",
  "phase2.header1.list1.1": "Provide context of user problems and business goals before sharing designs",
  "phase2.header1.list1.2": "State what type of feedback do you want (UX, UI, content, focused on specific area)",
  "phase2.header1.list1.3": "If unsure of a solution, walk through explorations",

  "phase2.header1.list2.title": "When providing feedback remember to:",
  "phase2.header1.list2.1": "Have an understanding on the context and goals before providing feedback",
  "phase2.header1.list2.2": "Frame your feedback around the user problem and goals",
  "phase2.header1.list2.3": "Lead with questions rather than problem solving",
  "phase2.header1.list2.4": "Provide rationale",
  "phase2.header1.list2.5": "Remain objective, and avoid personal ‘I don’t like…’",
  "phase2.header1.list2.6": "Be conscious of where we are in the process (eg. content not finalized in wireframes)",

  "phase2.subheader2": "Refine designs with engineering in mind",
  "phase2.description2": "While you may want to build the most flashy new experience, you’ll make a bigger impact if you understand the tradeoffs of feasibility and level of effort against user needs.",
  "phase2.header2.list1.title": "While discussing level of effort vs. user needs, ask:",
  ...
  "phase3.description1": "As a designer, you should document and annotate work so that engineers can quickly understand designs and begin implementation.",

  "phase3.header1.list1.title": "Leave no state behind",
  "phase3.header1.list1.desc": "Be mindful of end to end user flow and all states including:",
  ...
  "phase3.header1.list2.desc": "For designers, ensure you are using existing OTKit components using Figma libraries. If you don’t see a component in Figma, review the decision tree and come to OTKit Office Hours. We can help you!",

  "phase3.header1.list3.title": "Reference Buffet/CFE",
  "phase3.header1.list3.desc": "When annotating designs, refer to existing patterns in Buffet/CFE. If it’s not in Buffet/CFE, communicate if it needs to be added, modified or AB tested. Before you add components to Buffet/CFE, make sure it is approved during OTKIt Office Hours.",

  "phase3.subheader2": "Keep track of the work",
  "phase3.description2": "During implementation, engineers and designers can use Jira to keep track of all upcoming work and changes",

  "phase3.header2.list1.title": "Provide details in Jira",
  "phase3.header2.list1.desc": "Depending on the team, engineering or design must ensure Jira tickets are aligned to the design (eg. naming conventions / tokens). Use live embed Figma frames or attach images/screenshots into Jira tickets so engineers can reference current design as well as historical changes.",

  "phase3.header2.list2.title": "Communicate when designs have changed",
  "phase3.header2.list2.desc": "Designs can change after engineers have reviewed the work. Avoid confusion by giving a deadline to engineers on when designs will be complete. If you do need to change after engineering has reviewed, over-communicate in Figma, Jira or Slack to ensure they’re aware of updates.",

  "phase4": "Phase 4",
  "phase4.header": "Review",
  "phase4.subheader1": "Quality check everything (and yes, we mean everything!)",
