...
export default ({ children, nav = null, className = '' }) => {
  ...
  function getPartiallyActive() {
    if (typeof window !== 'undefined') {
      return window.location.pathname.includes('/otkit/');
    }
  }
  ...
  return (
    <div>
      <div className={styles.header}>
        ...
        <ul>
          <li>
            <Link to="/" className={styles.headerLink} activeClassName={styles.headerLinkActive} partiallyActive={getPartiallyActive()}>
              Design tokens
            </Link>
          </li>
          <li>
