...
export default ({addHashRoute}) => (
  <div className={styles.mainContainer}>
    ...
    <p className={`${styles.subtext} ${styles.mt0}`}>
      ...
      visual or interaction bugs in Jira or create a design QA document <a className={styles.link} target="_blank" href="https://docs.google.com/spreadsheets/d/1MMqCNwuekumASLel3F9juv9ZJ_l1K22Hg3RiGS7X7Co">(example)</a>. Engineering and design should
